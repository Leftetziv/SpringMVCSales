...
<html>
    ...
    <body>
        ...
        <form method="POST" action="${pageContext.request.contextPath}/product/update/${productToEdit.pcode}">
            <table
                <tr>
                    <th><label for="pcode">Code:</label></th>
                    <th><input type="number" name="pcode" id="pcode" value="${productToEdit.pcode}" disabled ></th>
                </tr>               
                <tr>
                ...
                <tr>
                    ...
                    <th><input type="text" name="pprice" id="pprice" value="${productToEdit.pprice}"></th>
                </tr> 
                <tr>
